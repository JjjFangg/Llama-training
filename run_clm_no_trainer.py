...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Initialize tiny llama for fast debug. "
        ),
    )
...
def main():
    ...
    if args.debug:
        cache_dir = '/home/qinyujia/CPM-Bee-main/raw_data/PG19_gpt2_long_preprocess_strict_20_multiFiles_bsz2.json'
    else:
        # cache_dir = '/home/qinyujia/project/unimem-master/PG19_long_preprocess_strict_512_multiFiles_bsz4.json'
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(active_dataloader):
            ...
            if step % args.eval_per_n_step == args.eval_per_n_step - 1:
                test_start_time = time.time()
                if accelerator.is_main_process:
                    print('step', step, completed_steps, 'eval--------------------------------')
                model.eval()
                losses = []
                    ...
                    accelerator.log(
                        {
                            ...
                            "eval_loss": eval_loss,
                            "train_loss": total_loss.item() / completed_steps,  # todo: len(train_dataloader),
                            "epoch": epoch,
                            "step": completed_steps,
                        },
                        step=completed_steps,
